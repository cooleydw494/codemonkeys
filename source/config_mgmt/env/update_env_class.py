...
from source.config_mgmt.env.get_env_prop_type import get_env_prop_type
...
def update_env_class():
    ...
    # Get the .env.default file variables (source env props)
    ...
    # Get source environment variables and generate corresponding class definitions
