...
from defs import ROOT_PATH, COMMANDS_PATH, BARRELS_PATH, AUTOMATIONS_PATH, MODULES_PATH, nl, CORE_HELP_PATH
from source.help.help import run_default_help
from source.utils.find_entity import find_entity
from source.utils.monk.run_as_module import run_as_module
from source.utils.monk.theme.theme_functions import print_t, print_tree
...
def handle_special_commands(args, action, entity, entity_type):
    ...
    # Help needs to work in many contexts, and it would be a pain to place help executables throughout the source,
