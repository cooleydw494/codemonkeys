...
CM_STOR_TEMP_PATH = os.path.join(CM_STOR_PATH, "_temp")
...
CM_MONKEY_CONFIG_CLASS_DEFAULT_PATH = os.path.join(CM_CONFIG_PATH, "monkey_config.py")
...
CM_CONTEXT_FILE_EXAMPLE_PATH = os.path.join(CM_ENTITY_EXAMPLES_PATH, '_context-file.txt')
