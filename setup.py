...
from modules.internal.utils.symlinks import check_definitions
...
check_definitions(os.path.abspath('definitions.py'), os.path.abspath('modules/definitions.py'), verify_symlink=True)
environment_checks()
