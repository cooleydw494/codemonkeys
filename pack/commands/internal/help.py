...
from definitions import STORAGE_PATH
...
def main():
    ...
    monk_general_file = os.path.join(STORAGE_PATH, 'monk', 'monk-commands-general.json')
    ...
    monk_type_file = os.path.join(STORAGE_PATH, 'monk', 'monk-commands-type.json')
    ...
    monk_action_file = os.path.join(STORAGE_PATH, 'monk', 'monk-commands-action.json')
