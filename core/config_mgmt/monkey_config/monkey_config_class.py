...
from config.defs import MONKEYS_PATH
from core.config_mgmt.env.env_class import ENV
from core.config_mgmt.monkey_config.monkey_config_validations import is_prompt_key
from core.config_mgmt.yaml_helpers import get_monkey_config_defaults
...
class MonkeyConfig:
    ...
    def load(cls, monkey_name: str) -> 'MonkeyConfig':
        from core.config_mgmt.yaml_helpers import read_yaml_file
