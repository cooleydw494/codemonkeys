...
from config.defs import ENV_CLASS_PATH, ROOT_PATH, STOR_DEFAULTS_PATH, nl
from core.config_mgmt.env.get_env_prop_type import get_env_prop_type
...
def update_env_class():
    ...
    # Get the .env.default file variables (core env props)
    framework_env_vars = dotenv_values(os.path.join(STOR_DEFAULTS_PATH, ".env.default"))
    ...
    # Get core environment variables and generate corresponding class definitions
